...
if(isset($_GET['delete'])){
  $sno = $_GET['delete'];
  $delete = true;
  $sql = "DELETE FROM `id_cards` WHERE `sno` = $sno";
...
if ($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    if($name == '' || $id_no == ''){
        ...
        $querry = mysqli_query($connection, "SELECT * FROM cards WHERE id_no= '$id_no' ");
      ...
      <div class="modal-content">
        ...
        <form method="POST">
          <div class="modal-body">
            ...
            <div class="form-group">
              <label for="desc"> Employee ID Card Number:</label>
  ...
  <div class="card card-body">
    ...
    <div class="form-row">
      <div class="form-group col-md-6">
        ...
        <input type="text" name="name" class="form-control" id="inputCity" required="write your name">
      </div>
      <div class="form-group col-md-4">
        <label for="inputState">Designation</label>
        <select name="designation" class="form-control" required="pleas enter designation">
          <option selected>Choose...</option>
          <option value="Web Developer">Web Developer</option>
          <option value="Python Developer">Python Developer</option>
          <option value="Mern Developer">Mern Developer</option>
          <option value="Software Developer">Software Developer</option>
          <option value="Computer Developer">Computer Developer</option>
